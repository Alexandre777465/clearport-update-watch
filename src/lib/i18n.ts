...
const DICT = {
  ...
  doc_outstanding_prefix: { en: "Outstanding compliance items:", zh: "待处理合规事项：" },
  doc_outstanding_suffix: { en: "item(s) outstanding", zh: "项待处理" },
  doc_timing_customs: { en: "at customs clearance", zh: "清关时所需" },
  doc_timing_before_sale: { en: "before sale", zh: "销售前所需" },
  doc_timing_usually_requested: { en: "usually requested", zh: "通常需提供" },
  doc_timing_transport: { en: "for transport", zh: "运输所需" },
  doc_none: {
  ...
  imp_costs_s232_auto: { en: "Automobile-parts Section 232", zh: "232 条汽车零部件关税" },
  imp_costs_s122: { en: "Section 122 temporary surcharge", zh: "第122条临时附加税" },
  imp_cost_confirmed: { en: "Applies", zh: "适用" },
  imp_cost_within_scope: { en: "Within scope", zh: "在范围内" },
  imp_cost_cannot_determine: { en: "Cannot determine", zh: "无法确定" },
  imp_cost_applies: { en: "Applies", zh: "适用" },
  imp_cost_does_not_apply: { en: "Does not apply", zh: "不适用" },
  ...
  imp_cost_informational: { en: "Informational — no specific mandatory rule identified", zh: "参考信息——未发现具体强制性规则" },
  ...
  // ── 4-section result page ────────────────────────────────────────────────
  sec1_title: { en: "What you will pay", zh: "您将支付的费用" },
  sec1_charge: { en: "Charge", zh: "费用项目" },
  sec1_rate: { en: "Rate", zh: "税率" },
  sec1_amount: { en: "Amount (est.)", zh: "金额（估算）" },
  sec1_known_total: { en: "Known amount payable", zh: "已知应付金额" },
  sec1_cannot_total: { en: "Final total cannot be calculated — missing", zh: "最终总额暂无法计算——缺少" },
  sec2_title: { en: "What you need to clear customs", zh: "通关所需文件" },
  sec2_group_a: { en: "Get from your supplier", zh: "向供应商获取" },
  sec2_group_b: { en: "Filed by importer or customs broker", zh: "由进口商或报关行申报" },
  sec2_group_c: { en: "Provided by carrier", zh: "由承运人提供" },
  sec3_title: { en: "Laws and product requirements", zh: "法律法规与产品要求" },
  sec3_before_sale: { en: "Before sale", zh: "销售前" },
  sec3_for_customs: { en: "For customs clearance", zh: "通关要求" },
  sec3_conditional: { en: "Applies when:", zh: "适用条件：" },
  sec4_title: { en: "What could affect your margin", zh: "可能影响利润的因素" },
  official_details_title: { en: "Official details and sources", zh: "官方详情与来源" },
  info_missing_title: { en: "Information still missing", zh: "尚缺信息" },
  info_missing_none: { en: "No material information remains unresolved for this preliminary screening.", zh: "本次初步审查没有重大未解决信息。" },
  clarif_missing_info: { en: "Missing information:", zh: "缺失信息：" },
  clarif_why_matters: { en: "Why it matters:", zh: "重要原因：" },
  clarif_affects: { en: "Affects:", zh: "影响：" },
  clarif_resubmit: { en: "To complete this analysis, re-submit with the correct answer selected:", zh: "如需完成分析，请重新提交并选择正确答案：" },
  postscan_q_heading: { en: "One question before your report", zh: "报告前的一个问题" },
  postscan_q_continue: { en: "Continue →", zh: "继续 →" },
  postscan_q_skip: { en: "Skip — show report anyway", zh: "跳过 — 直接查看报告" },
  next_steps_title: { en: "Next steps", zh: "后续步骤" },
  doc_status_required_to_clear: { en: "Required to clear customs", zh: "通关必需" },
  doc_status_required_if: { en: "Required if", zh: "在以下情况要求" },
  doc_status_usually_requested: { en: "Usually requested", zh: "通常被要求" },
  doc_status_before_sale: { en: "Required before sale", zh: "销售前必需" },
  doc_status_not_required: { en: "Not required", zh: "不要求" },
  doc_status_cannot_determine: { en: "Cannot determine", zh: "无法确定" },
  resp_supplier: { en: "Supplier", zh: "供应商" },
  resp_importer: { en: "Importer", zh: "进口商" },
  resp_customs_broker: { en: "Customs broker", zh: "报关行" },
  resp_carrier: { en: "Carrier", zh: "承运人" },
  resp_laboratory: { en: "Laboratory", zh: "检测机构" },
  law_status_required: { en: "Required", zh: "要求" },
  law_status_not_required: { en: "Not required", zh: "不要求" },
